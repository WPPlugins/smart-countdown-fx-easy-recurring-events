	...
	private static function displaySettings( $preset_index ) {
		...
		?>
			...
			<tr valign="top" class="scd-er-hide scd-er-interval">
				<th scope="row"><label for="<?php echo self::$option_prefix; ?>interval_<?php echo $preset_index; ?>"><?php _e( 'Interval', self::$text_domain ); ?></label></th>
				<td>
			...
			<tr valign="top" class="scd-er-hide scd-er-time">
				<th scope="row"><label for="<?php echo self::$option_prefix; ?>duration_<?php echo $preset_index; ?>"><?php _e( 'Duration (hh:mm)', self::$text_domain ); ?></label></th>
				<td>
